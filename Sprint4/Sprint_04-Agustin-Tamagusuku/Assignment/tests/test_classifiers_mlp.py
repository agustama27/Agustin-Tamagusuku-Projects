...
def test_result_files():
    ...
    multimodal_results_path = os.path.join(results_dir, "multimodal_results.csv")
    text_results_path = os.path.join(results_dir, "text_results.csv")
    image_results_path = os.path.join(results_dir, "image_results.csv")
